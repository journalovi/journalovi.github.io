...
To submit to the experimental track, write your paper in quarto using [this template](https://github.com/journalovi/jovi-template-quarto) and then email us your paper information and a link to your repository at [submit@journalovi.org](mailto:submit@journalovi.org).
