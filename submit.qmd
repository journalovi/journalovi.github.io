...
JoVI organizers process articles in batches at the end of each month, __except March and September__. Articles submitted by __the end of Friday (AoE)__ each month will be processed in that month's batch. The reviewing timeline is roughly as follows:
