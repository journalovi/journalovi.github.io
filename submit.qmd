...
JoVI encourages [registered reports](https://www.cos.io/initiatives/registered-reports). See the [Registered Reports author guidelines](registered-reports.qmd).
...
2. Start:
    ...
    * In the Comments for the Editor section, please indicate:
      1. Whether you are submitting anonymously.
      2. Whether you prefer the reviewing process to be run on OJS or Github (Authors who are familiar with Github may benefit from avoiding the hassle with OJS.)
...
JoVI organizers process articles in batches at the end of __January, February, May, June, July, August, and November__. Articles submitted by __the end of last Friday (AoE) of each month__ will be processed in that month's batch. The reviewing timeline is roughly as follows:
