...
2. Start:
    ...
    * If you are more familiar with GitHub than our reviewing platform (OJS), you can choose to have the reviewing process carried out on GitHub by indicating so in the `Comments for the Editor` section.
