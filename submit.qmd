...
Submission for the traditional track proceeds via ... **INSERT INFO HERE**
...
All papers in the "Github" track must be written in [Quarto](https://quarto.org/), a markdown-based computational notebook format. Quarto can be used with documents written in a variety of forms (RMarkdown, Jupyter notebook, Word, Latex), and supports embedded computation (in mayn languages, including R, python, and Julia) and interactivity (using JavaScript / Observable).
