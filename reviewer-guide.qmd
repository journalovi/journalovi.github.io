...
For the criteria you are asked to assess at each stage, see the [Registered Reports reviewer guidelines](registered-reports-reviewers.qmd). The full process and the requirements placed on authors are described in the [Registered Reports author guidelines](registered-reports.qmd).
...
__Accelerated review turnaround:__ The associate editor can propose to make the reject or revision decisions based on only 1–2 reviews. 
The JoVI organizer responsible for the paper shall review the proposal based on (1) thoroughness of the reviews, and (2) collective expertise of the reviewers and the AE in light of the paper's contribution.
