...
If you have been invited as an associate editor for JoVI, we also suggest looking through the [OJS Editorial Workflow](https://docs.pkp.sfu.ca/learning-ojs/3.3/en/editorial-workflow) documentation and the corresponding [FAQ](https://docs.pkp.sfu.ca/faq/en/editorial-workflow).
