...
We provide some example sections you may want to include in your structured abstract below, depending on the type of work. 
...
See also (partial) [examples of structured abstracts](https://www.journalovi.org/structured-abstract-examples.html).
