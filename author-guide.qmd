...
JOVI encourages you to use [structured abstracts](https://www.nlm.nih.gov/bsd/policy/structured_abstracts.html), with distinct, labeled sections for rapid comprehension. 

- For an article with empricial research contribution, your abstract might have the following sections:
   - Introduction 
   - Data collection
   - Data analysis
   - Results
...
- For an systems research article, your abstract might have the following sections:
   - Problem
   - Implementation
   - Demonstration
   - Lessons learned

These are only examples. Authors may choose alternative structure that are suitable to the research contributions in their paper while faciliating rapid comprehension.
